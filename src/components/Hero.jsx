export default function Hero() {
    return (
        <section className="flex flex-col items-center h-screen justify-center text-white text-center py-24 px-6">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2rem] px-10 py-12 shadow-2xl max-w-5xl">
                ...
                <p className="max-w-2xl text-xl leading-relaxed mx-auto">
